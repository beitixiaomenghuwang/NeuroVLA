...
run_id=1121_spikevla_onlyspi_spike_goal_dualimage_ac8_768*2
...
framework_name=spikevla_onlyspi
...
accelerate launch \
  ...
  --config_yaml /workspace/llavavla0/starVLA/config/training/internvla_cotrain_custom.yaml \
