...
# Modification: [add fake sample and predict_action to match with NeuroVLA].
"""
...
from NeuroVLA.model.modules.action_model.DiTActionHeader import get_action_model
